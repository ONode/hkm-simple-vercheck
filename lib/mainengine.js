...
var vmgr = fs.readFileSync('node_modules/npm-check-updates/lib/versionmanager.js', 'utf8');
eval(vmgr);
/**
...
var version_checker = function (declaration, latestVersion) {
    var determine = vmgr.upgradeDependencyDeclaration(declaration, latestVersion);
    this.message = "";
